# Multitool pack : English - US
 ...
 You need to pip install these extentsions!
...
¡Necesitas instalar estas extensiones!
pip install requests
pip install colorama
pip install discord
pip install uuid
...
Вам необходимо установить эти расширения через pip!
pip install requests
pip install colorama
pip install discord
pip install uuid
...
in der Zwietracht. Das Programm wird übersetzt, wenn es fertig ist!
 Sie müssen diese Erweiterungen installieren!
pip install requests
pip install colorama
pip install discord
pip install uuid
